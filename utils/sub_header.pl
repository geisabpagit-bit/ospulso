        ...
        <div class="container-fluid px-lg-4 d-flex align-items-center justify-content-between flex-nowrap">
            ...
            <div class="d-none d-md-flex align-items-center gap-4 me-auto">
                <a class="navbar-brand d-flex flex-column align-items-center justify-content-center m-0 text-decoration-none" href="../index.html" title="Inicio" style="font-family: 'Outfit', sans-serif; font-weight: 800; font-size: 2.6rem; letter-spacing: 0.5px; line-height: 0.95;">
                    ...
                    <svg class="ekg-pulse animate__animated animate__pulse animate__infinite animate__slower" viewBox="0 0 100 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 140px; height: 12px; margin-top: -2px;">
                        <path d="M0 10H55L60 3L67 17L73 1L78 13L82 10H100" stroke="var(--md-green-medical)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" style="filter: drop-shadow(0 0 2px rgba(16, 185, 129, 0.6));" />
                    </svg>
                </a>
