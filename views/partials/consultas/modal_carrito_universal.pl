package partials::consultas::modal_carrito_universal;
use strict;
use warnings;
use utf8;
                ...
                <div class="row g-3">
                    <div class="col-lg-7">
                        ...
                        <div class="mb-2 d-flex gap-2">
                            <select id="filtroDepartamento" class="form-select form-select-sm shadow-sm" onchange="filtrarCatalogo()" style="border-color: var(--md-gray-soft, #D9E2EC); font-family: 'Plus Jakarta Sans', sans-serif;">
                                <option value="">Todos los Departamentos</option>
                            </select>
                            <select id="filtroCategoria" class="form-select form-select-sm shadow-sm" onchange="filtrarCatalogo()" style="border-color: var(--md-gray-soft, #D9E2EC); font-family: 'Plus Jakarta Sans', sans-serif;">
                        ...
                        <div class="position-relative mb-2">
                            ...
                            <input type="text" id="buscadorCatalogo"
                                ...
                                placeholder="Buscar en catálogo de servicios y productos..."
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-1 px-1">
                            <span class="small fw-bold text-muted" style="font-size: 0.75rem;">Resultados: <span id="totalConceptosBadge" class="badge bg-primary rounded-pill">0</span></span>
                        </div>
